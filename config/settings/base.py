...
MIGRATION_MODULES = {"sites": "visa_port.contrib.sites.migrations"}
...
AUTH_PASSWORD_VALIDATORS = [
    ...
    # {'NAME': 'visa_port.utils.validators.CustomPasswordValidator'},
]
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "visa_port.utils.context_processors.settings_context",
            ],
        },
    }
]
...
# https://django-allauth.readthedocs.io/en/latest/configuration.html
ACCOUNT_ADAPTER = "visa_port.apps.users.adapters.AccountAdapter"
# https://django-allauth.readthedocs.io/en/latest/forms.html
ACCOUNT_FORMS = {"signup": "visa_port.apps.users.forms.UserSignupForm"}
# https://django-allauth.readthedocs.io/en/latest/configuration.html
SOCIALACCOUNT_ADAPTER = "visa_port.apps.users.adapters.SocialAccountAdapter"
# https://django-allauth.readthedocs.io/en/latest/forms.html
SOCIALACCOUNT_FORMS = {"signup": "visa_port.apps.users.forms.UserSocialSignupForm"}
...
REST_FRAMEWORK = {
    ...
    "EXCEPTION_HANDLER": "visa_port.utils.exception_handlers.custom_exception_handler",
...
SWAGGER_SETTINGS = {
    "DEFAULT_AUTO_SCHEMA_CLASS": "visa_port.utils.api.schema.CustomAutoSchema",
